	...
	$('body').on('click', '.c-arrow', function(){

		if(!click_categorie) click_categorie = 'c-arrow'
		
		var x = this;
		var li = x.parentNode.parentNode;
		var tag = x.parentNode;

		var categorie_id = $(tag).attr('value')

		if(click_categorie == 'c-arrow'){
	...
	$('body').on('click', '#load_subcategories_by_categorieid', function(){
		...
		if(!click_categorie) click_categorie = 'load_subcategories_by_categorieid'
		
		if(click_categorie == 'load_subcategories_by_categorieid'){
			window.location.href = '/categorie/' + categorie_id;
		}
