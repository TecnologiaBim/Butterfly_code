...
router.post('/get_content_body_info', page.get_content_body_info);
...
router.post('/load_categories', categorie.load_categories);
router.post('/get_brands', page.get_brands);
router.post('/load_subcategories', mw.obtieneSesion, mw.validaSesion, mw.validaEstadoUsuario, categorie.load_subcategories);
router.post('/load_categories_by_id', categorie.load_categories_by_id);
router.post('/load_subcategories_by_id', categorie.load_subcategories_by_id);
...
router.post('/load_subcategories_by_categorieid', categorie.load_subcategories_by_categorieid);

router.post('/update_product', mw.obtieneSesion, mw.validaSesion, mw.validaEstadoUsuario, product.update_product);
router.post('/register_new_product', mw.obtieneSesion, mw.validaSesion, mw.validaEstadoUsuario, product.register_new_product);
router.post('/load_products', product.load_products);
router.post('/load_product_by_id', product.load_product_by_id);
router.post('/load_products_by_categorie_id', product.load_products_by_categorie_id);
router.post('/load_products_by_subcategorie_id', product.load_products_by_subcategorie_id);
router.post('/remove_product', mw.obtieneSesion, mw.validaSesion, mw.validaEstadoUsuario, product.remove_product);
